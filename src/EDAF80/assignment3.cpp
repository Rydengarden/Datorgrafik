...
edaf80::Assignment3::run()
{
    ...
    demo_sphere.add_texture("diffuse_texture", bonobo::loadTexture2D(config::resources_path("textures/cobblestone_floor_08_diff_2k.jpg")), GL_TEXTURE_2D);
    demo_sphere.add_texture("specular_texture", bonobo::loadTexture2D(config::resources_path("textures/cobblestone_floor_08_rough_2k.jpg")), GL_TEXTURE_2D);
    demo_sphere.add_texture("normal_map", bonobo::loadTexture2D(config::resources_path("textures/cobblestone_floor_08_nor_2k.jpg")), GL_TEXTURE_2D);
