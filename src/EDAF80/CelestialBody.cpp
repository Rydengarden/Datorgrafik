                                ...
                                bool show_basis)
{
    ...
    glm::mat4 t = glm::translate(glm::mat4(1.0f),glm::vec3(_body.orbit.radius,0.0f,0.0f));
    ...
    //world = r1s*r2s*t*s;
    world = parent_transform * r1o * t * r2o * r2s * r1s * s;
    ...
    return parent_transform * r1o * t * r2o * r2s;
}
